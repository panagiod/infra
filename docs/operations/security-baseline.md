...
Couchbase Server is deployed as **Community Edition** (`couchbase/server:community-7.6.0`) via a StatefulSet — the Autonomous Operator requires Enterprise. See [licenses.md](../reference/licenses.md).
