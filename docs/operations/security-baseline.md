...
Couchbase Server is pinned to **Community Edition** (`couchbase/server:community-7.6.0`) with operator chart **2.64.1** (operator 2.9+ requires Enterprise). See [licenses.md](../reference/licenses.md).
